...
# source of truth: src/storix/_async/backends/memory.py
# ruff: noqa: A004
...
from storix._sync._stream import chunked, collect, resolve_chunk_size
...
class MemoryBackend(BackendBase):
    ...
    def list_dir(self, path: PurePosixPath) -> Iterator[Entry]:
        ...
        is_file = (self.stat(path)).kind is PathKind.FILE
        if is_file:
